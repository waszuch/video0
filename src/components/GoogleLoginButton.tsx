...
export const GoogleLoginButton = () => {
	return (
		...
		>
			...
			<div className="relative flex items-center justify-center z-10 rounded-2xl bg-gradient-to-b from-purple-600 to-purple-800 py-3 px-4 ring-1 ring-purple-700/30 transition-colors duration-200 group-hover:from-purple-700 group-hover:to-purple-900">

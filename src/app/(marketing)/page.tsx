...
const NavButton = ({ href, filled = false, children }: NavButtonProps) => (
  ...
  >
    ...
    <div
      className={`relative flex items-center z-10 rounded-2xl ${
        filled ? "bg-gradient-to-b from-purple-600 to-purple-800" : "bg-black"
      } py-1.5 px-4 ring-1 ring-purple-700/30`}
    >
      {children}
    </div>
        ...
        <div className="flex flex-col p-8 lg:p-16 relative">
          ...
          <div className="flex-grow flex flex-col justify-center">
            ...
            <p className="text-lg text-gray-300 mb-8">
              Generate personalized videos for your friends and family in
              seconds
            </p>

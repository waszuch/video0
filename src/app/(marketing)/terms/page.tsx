...
export const metadata: Metadata = {
	title: "Terms of Service | Video0",
	description: "Terms of service for Video0, the video generation platform",
};
...
These Terms of Service constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you") and Milosz Jankiewicz Ventures ("Company," "we," "us," or "our"), concerning your access to and use of the [https://video0.dev](https://video0.dev) website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the "Site"). We are registered in Poland and have our registered office at Sikorskiego 38D/4, Grudziądz, Kujawsko-Pomorskie 86-300. Our VAT number is PL8762438035. You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Service. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF SERVICE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.
...
As a user of the Site, you agree not to (including but not limited to):
...
- Upload images containing nudity
...
These conditions are governed by and interpreted following the laws of Poland, and the use of the United Nations Convention of Contracts for the International Sale of Goods is expressly excluded. If your habitual residence is in the EU, and you are a consumer, you additionally possess the protection provided to you by obligatory provisions of the law of your country of residence. Milosz Jankiewicz Ventures and yourself both agree to submit to the non-exclusive jurisdiction of the courts of Cracow, which means that you may make a claim to defend your consumer protection rights in regards to these Terms of Service in Poland, or in the EU country in which you reside.
...
Any dispute arising from the relationships between the Parties to this contract shall be determined by one arbitrator who will be chosen in accordance with the Arbitration and Internal Rules of the European Court of Arbitration being part of the European Centre of Arbitration having its seat in Strasbourg, and which are in force at the time the application for arbitration is filed, and of which adoption of this clause constitutes acceptance. The seat of arbitration shall be Cracow, Poland. The language of the proceedings shall be Polish. Applicable rules of substantive law shall be the law of Poland.
...
Milosz Jankiewicz Ventures  
Email: [privacy@video0.dev](mailto:privacy@video0.dev)
`;
